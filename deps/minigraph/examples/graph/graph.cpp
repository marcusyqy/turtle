...
struct Graph {
    ...
    mini::Edge<T>& edge(T&& t) {
        std::cout << "allocating edge:" << std::dec << sizeof(mini::Edge<T>) << "align " << alignof(mini::Edge<T>) << std::endl;
    ...
    typename mini::Node<T>::Outputs& node(
        typename mini::Node<T>::Inputs inputs, Args&&... args) {
        std::cout << "allocating node:" << std::dec << sizeof(mini::Node<T>) << "align " << alignof(mini::Node<T>) << std::endl;
